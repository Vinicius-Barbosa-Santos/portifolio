      ...
      <figure>
        ...
        <blockquote className="mb-6">
          <p className="text-2xl text-gray-900">
            Vinicius é a típica pessoa que surpreende a todos com seu conhecimento. Tenho o prazer de recomendá-lo como Desenvolvedor Web FullStack. Durante o tempo em que trabalhei com Vinicius, pude encontrar uma inspiração para seguir no desenvolvimento web com React. Elaboramos diversas ideias de projetos e hoje seguimos com conhecimentos atuais do mercado FullStack.
          </p>
        </blockquote>
