...
export default function About() {
  return (
    <section id="sobre" className="scroll-mt-20 md:scroll-mt-24 container mx-auto my-12 max-w-5xl p-4">
      <div className="relative p-4 text-center">
        ...
        <p className="relative text-sm text-white">
          Estou sempre em busca de aprimoramento contínuo, mantendo-me atualizado com as últimas tendências e melhores práticas do setor.
        </p>
        ...
        <div className="relative flex flex-col items-center gap-8 md:flex-row md:items-start md:gap-12">
          ...
          <div className="relative flex-1 rounded-2xl bg-white/5 p-6 shadow-xl ring-1 ring-white/10 backdrop-blur md:p-8">
            <div className="rounded-xl bg-white/5 p-6 ring-1 ring-white/10">
              <p className="font-handwriting text-lg font-bold text-white">Olá,</p>
              <p className="text-white">
                <span className="mr-1">Meu nome é</span>
                <span className="font-headline font-bold tracking-wide text-white">VINICIUS</span>
                <br />
                <span className="font-headline font-bold text-white">BARBOSA</span>
              </p>

              <table className="mt-5 w-full text-sm text-white">
                <tbody>
                  <tr>
                    <td className="w-32 font-headline font-bold uppercase text-white">Idade:</td>
                    <td>28</td>
                  </tr>
                  <tr>
                    <td className="font-headline font-bold uppercase text-white">Celular:</td>
                    <td>
                      <a href="https://wa.me/5548992017424" className="underline hover:text-cyan-300" target="_blank" rel="noreferrer">
                        +55 48 99201-7424
                      </a>
                    </td>
                  </tr>
                  <tr>
                    <td className="font-headline font-bold uppercase text-white">Endereço:</td>
                    <td>
                      <a
                  ...
                  <tr>
                    <td className="font-headline font-bold uppercase text-white">Disponível:</td>
                    <td>
